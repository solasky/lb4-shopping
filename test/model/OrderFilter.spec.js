...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Loopback4ExampleShopping.OrderFilter();
  });
  ...
  describe('OrderFilter', function() {
    it('should create an instance of OrderFilter', function() {
      ...
      //var instance = new Loopback4ExampleShopping.OrderFilter();
      //expect(instance).to.be.a(Loopback4ExampleShopping.OrderFilter);
    });
