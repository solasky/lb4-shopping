...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Loopback4ExampleShopping.OrderScopeFilter();
  });
  ...
  describe('OrderScopeFilter', function() {
    it('should create an instance of OrderScopeFilter', function() {
      // uncomment below and update the code to test OrderScopeFilter
      //var instance = new Loopback4ExampleShopping.OrderScopeFilter();
      //expect(instance).to.be.a(Loopback4ExampleShopping.OrderScopeFilter);
    });
