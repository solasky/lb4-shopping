...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Loopback4ExampleShopping.KeyAndPassword();
  });
  ...
  describe('KeyAndPassword', function() {
    it('should create an instance of KeyAndPassword', function() {
      // uncomment below and update the code to test KeyAndPassword
      //var instance = new Loopback4ExampleShopping.KeyAndPassword();
      //expect(instance).to.be.a(Loopback4ExampleShopping.KeyAndPassword);
    });
